...
void oil_xscale_up_rgba_sse2(unsigned char *in, int width_in, float *out,
	float *coeff_buf, int *border_buf);
void oil_yscale_out_argb_sse2(float *sums, int width, unsigned char *out,
	int tap);
void oil_yscale_up_argb_sse2(float **in, int len, float *coeffs,
	unsigned char *out);
void oil_xscale_up_argb_sse2(unsigned char *in, int width_in, float *out,
	float *coeff_buf, int *border_buf);
void oil_scale_down_argb_sse2(unsigned char *in, float *sums_y, int out_width,
	float *coeffs_x, int *border_buf, float *coeffs_y, int tap);
...
void oil_yscale_out_rgba_nogamma_sse2(float *sums, int width,
	unsigned char *out, int tap);
...
void oil_xscale_up_argb_neon(unsigned char *in, int width_in, float *out,
	float *coeff_buf, int *border_buf);
void oil_scale_down_argb_neon(unsigned char *in, float *sums_y, int out_width,
	float *coeffs_x, int *border_buf, float *coeffs_y, int tap);
...
void oil_scale_down_rgba_nogamma_neon(unsigned char *in, float *sums_y,
	int out_width, float *coeffs_x, int *border_buf, float *coeffs_y,
	int tap);
void oil_yscale_out_rgbx_nogamma_neon(float *sums, int width,
	unsigned char *out, int tap);
...
void oil_xscale_up_rgbx_nogamma_neon(unsigned char *in, int width_in, float *out,
	float *coeff_buf, int *border_buf);
void oil_scale_down_rgbx_nogamma_neon(unsigned char *in, float *sums_y,
	int out_width, float *coeffs_x, int *border_buf, float *coeffs_y,
	int tap);
#endif
