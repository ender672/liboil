...
all: test test_libjpeg imgscale benchmark coeffbench
...
clean:
	rm -rf test test.dSYM test_libjpeg test_libjpeg.dSYM oil_resample.o oil_resample_sse2.o oil_resample_avx2.o oil_resample_neon.o oil_libpng.o oil_libjpeg.o imgscale oilview benchmark coeffbench sdltest
