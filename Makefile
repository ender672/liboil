...
all: test test_libjpeg test_libpng test_libjxl imgscale benchmark coeffbench
...
test_libjxl: test_libjxl.c $(OIL_OBJS) oil_libjxl.o
	$(CC) $(CFLAGS) $(OIL_OBJS) oil_libjxl.o test_libjxl.c -o $@ $(LDFLAGS) -ljxl -ljxl_threads -lpthread -lm
...
clean:
	rm -rf test test.dSYM test_libjpeg test_libjpeg.dSYM test_libpng test_libpng.dSYM test_libjxl test_libjxl.dSYM oil_resample.o oil_resample_sse2.o oil_resample_avx2.o oil_resample_neon.o oil_libpng.o oil_libjpeg.o oil_libjxl.o imgscale oilview benchmark coeffbench sdltest
